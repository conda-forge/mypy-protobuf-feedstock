...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mypy-protobuf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11226&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mypy-protobuf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mypy-protobuf` can be installed with:

```
conda install mypy-protobuf
```

It is possible to list all of the versions of `mypy-protobuf` available on your platform with:
